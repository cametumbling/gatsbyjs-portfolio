  ...
  return (
    <Layout>
      <div>
        ...
        <p style={{ color: `#ccc`}}>      
        Hi! I'm Jill, a JavaScript-based web developer from California, working with technologies such as React, Node.js, Express, and PostgreSQL. (This site was built using Gatsby!) In a previous life, I was a GIS Data Analyst, so I'm great with data and I love maps! 
        <br/>
        <br/>
